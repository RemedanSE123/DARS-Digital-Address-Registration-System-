...
// Insert region data into the database along with the recorded_by information
$sql = "INSERT INTO temp_region (region_name, region_flag, region_map, description, recorded_by)
         VALUES ('$region', '$regionFlagPath', '$regionMapPath', '$description', '$userEmail')"; // Corrected syntax here
